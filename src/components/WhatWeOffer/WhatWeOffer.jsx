			...
			<section className='container'>
				<section className='what-we-offer-box-content row  align-items-center'>
					...
					<div className='col-lg-12 services-head-section mb-4 text-center'>
						...
						<p>
							منصة مُدَار توفر لك حلولًا متكاملة لإدارة فرق العمل عن بُعد، حيث
							تقدم أدوات فعالة لتسهيل التواصل، متابعة المهام، وقياس إنتاجية
							الموظفين، مما يضمن لك نجاح عملياتك التجارية بكفاءة عالية.
						</p>
					</div>
