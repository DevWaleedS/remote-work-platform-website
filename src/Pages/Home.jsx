	...
	return (
		<>
			<Helmet>
				<title>
					{" "}
					شركة المعرفة لتقنية المعلومات: منصتك الذكية لإدارة الموظفين عن بُعد
				</title>
				<meta
					name='description'
					content='حوّل إدارة فريقك مع شركة المعرفة لتقنية المعلومات، منصتك الشاملة لإدارة الموظفين عن
